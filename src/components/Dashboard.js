...
render() {
   ...
   <div >
       <button className="btn1"><Link to='/'>help</Link></button>
       <button className="btn2"><Link to='/login'>Login</Link></button>
        ...
        <div>
           ...
           <span> <img className="icon1" width="100px" height="100px" src={signup} alt='signup'/>
           <img className="icon2" width="100px" height="100px" src={connect} alt='connect'/>
           ...
           <h3 className="ictx1">interact</h3></span>
